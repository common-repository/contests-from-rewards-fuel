...
<div class="rf-contests-page">
	...
	<div class="into-para-signed-out">
		...
		<div class="col-md-5 rf-account-second-column">
			...
			<a href="https://app.rewardsfuel.com/api/Wp_v2/wp_redirect/?rd=https%3A%2F%2Faccounts.rewardsfuel.com%2Fplans%2F&key=<?php echo $rf_key; ?>" target="_blank" class=" btn-primary btn mt-2 mb-2 btn-block">Upgrade now</a>
