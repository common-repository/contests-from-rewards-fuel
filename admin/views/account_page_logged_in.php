...
<div class="rf-contests-page">
	<div class="top-area-accounts mb-5 text-left">
		...
		<div class="col-md-7">
			...
			<a  class="btn btn-primary" href="https://app.rewardsfuel.com/api/wp_v2/wp_redirect/?rd=https%3A%2F%2Fapp.rewardsfuel.com%2Faccount%2F&key=<?php echo $rf_key; ?>">Edit account</a>
			<a  class="btn btn-primary btn-upgrade d-none" href="https://app.rewardsfuel.com/api/wp_v2/wp_redirect/?rd=https%3A%2F%2Faccounts.rewardsfuel.com%2Fplans%2F&key=<?php echo $rf_key; ?>">Plan: <span class="plan_name"></span>  -> upgrade ></a>
			<a href="#" class="disconnect-key mt-5">Disconnect account from WordPress</a>
                <a href="#" style="display: block; " class="wheres-my-contest  mt-4">Not seeing contests, or missing an upgrade?</a>
			</div>
		</div>
		<div class="col-md-5">
	...
	<div class="account-footer-links">
        <a href="https://app.rewardsfuel.com/api/Wp_v2/wp_redirect/?rd=https%3A%2F%2Frewardsfuel.com%2Fprivacy&key=<?php echo $rf_key; ?>" target="_blank">Privacy policy</a>
        <a href="https://app.rewardsfuel.com/api/Wp_v2/wp_redirect/?rd=https%3A%2F%2Frewardsfuel.com&key=<?php echo $rf_key; ?>" target="_blank">About us</a>
