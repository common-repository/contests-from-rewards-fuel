...
<div class="rf-contests-page p-4 container-fluid">
	<nav class="mb-2 navbar navbar-expand-lg pl-0">
		...
		<div class="collapse navbar-collapse" id="rf-contest-nav">
			<ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item no-border-right">
                    <a href="https://app.rewardsfuel.com/api/Wp_v2/wp_rd/?rd=types_of_contests&key=<?php echo $rf_key; ?>" target="_blank" class="nav-link">Types of contests</a>
                </li>
				<li class="nav-item no-border-right">
					<a href="https://app.rewardsfuel.com/api/Wp_v2/wp_redirect/?rd=https%3A%2F%2Faccounts.rewardsfuel.com%2Fplans%2F&key=<?php echo $rf_key; ?>" target="_blank" class="nav-link">Upgrade</a>
				</li>
			</ul>
		...
		<div id="rf-dashboard">
            ...
            <a href="#" style="display: block; padding:1rem; text-align: center" class="wheres-my-contest">Missing contests or a paid upgrade?</a>
		</div>
