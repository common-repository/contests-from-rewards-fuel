...
rf_admin.init_listeners = function () {
	try {
		...
		jQuery(document).on("click", ".contest-name-area .visit-contest", function (e) {
			let url = `http://app.rewardsfuel.com/api/Wp_v2/visit_contest?c=${jQuery(this).data("id")}`;
			window.open(url)
		});
		...
		jQuery(document).on("click", ".wheres-my-contest", function (e) {
			...
			alertify.alert().set({
				...
				onfocus:function(){
					jQuery.get("https://app.rewardsfuel.com/api/wp_v2/wp_wrong_account",function (r){
...
jQuery(document).ready(function () {
	...
	jQuery(".upgrade-link").attr("href", `https://app.rewardsfuel.com/api/Wp_v2/wp_redirect/?rd=https%3A%2F%2Faccounts.rewardsfuel.com%2Fplans%2F&key=${ rf_wp_key }`).attr("target", "_blank");
